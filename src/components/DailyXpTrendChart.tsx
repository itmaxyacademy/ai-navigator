...
export const DailyXpTrendChart: React.FC<DailyXpTrendChartProps> = ({
  ...
  return (
    <div className="bg-white border-slate-200 text-slate-900 dark:bg-white dark:bg-slate-900 dark:border-slate-200 dark:border-slate-800 dark:text-slate-900 dark:text-white border rounded-3xl p-5 sm:p-6 space-y-4 shadow-xl">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-200 dark:border-slate-200 dark:border-slate-800/80 pb-4">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h3 className="text-base font-extrabold text-slate-900 dark:text-slate-900 dark:text-white flex items-center gap-2">
        ...
        <div className="flex items-center gap-1 bg-slate-100 dark:bg-slate-100 dark:bg-slate-950 p-1 rounded-xl border border-slate-200 dark:border-slate-200 dark:border-slate-800 self-start sm:self-auto">
          <button
            onClick={() => setChartType('area')}
            className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-bold transition-colors cursor-pointer ${
              chartType === 'area'
                ? 'bg-indigo-600 text-slate-900 dark:text-white shadow-sm'
                : 'text-slate-600 dark:text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-900 dark:text-white'
            }`}
          >
      ...
      <div className="grid grid-cols-3 gap-3 text-xs">
        <div className="p-3 bg-slate-50 dark:bg-slate-100 dark:bg-slate-950/80 border border-slate-200 dark:border-slate-200 dark:border-slate-800 rounded-2xl space-y-0.5">
          <span className="text-slate-600 dark:text-slate-500 dark:text-slate-400 font-semibold text-[11px] flex items-center gap-1">
