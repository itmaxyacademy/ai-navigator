  ...
  return (
    <div className="bg-slate-900 border border-slate-800 rounded-3xl p-5 sm:p-6 space-y-4 shadow-xl">
      ...
      <div className="grid grid-cols-3 gap-3 text-xs">
        <div className="p-3 bg-slate-950/80 border border-slate-800 rounded-2xl space-y-0.5">
          <span className="text-slate-400 font-semibold text-[11px] flex items-center gap-1">
            <Zap className="w-3.5 h-3.5 text-amber-400" /> Total 7 Hari
          </span>
          <div className="text-base font-black text-amber-400">+{sum7Days} XP</div>
        </div>

        <div className="p-3 bg-slate-950/80 border border-slate-800 rounded-2xl space-y-0.5">
          <span className="text-slate-400 font-semibold text-[11px] flex items-center gap-1">
            <TrendingUp className="w-3.5 h-3.5 text-indigo-400" /> Rata-Rata/Hari
          </span>
          <div className="text-base font-black text-indigo-300">+{avgDailyXp} XP</div>
        </div>

        <div className="p-3 bg-slate-950/80 border border-slate-800 rounded-2xl space-y-0.5">
          <span className="text-slate-400 font-semibold text-[11px] flex items-center gap-1">
            <Sparkles className="w-3.5 h-3.5 text-emerald-400" /> Peak Harian
          </span>
          <div className="text-base font-black text-emerald-400">+{maxXpDay} XP</div>
        </div>
      </div>
