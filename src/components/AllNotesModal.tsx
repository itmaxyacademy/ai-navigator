  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md animate-in fade-in duration-200">
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-3xl w-full max-w-4xl max-h-[85vh] flex flex-col shadow-2xl overflow-hidden">
        {/* Header */}
        <div className="p-5 bg-slate-950/80 border-b border-slate-800 flex items-center justify-between gap-4">
        ...
        {/* Search Bar */}
        <div className="p-4 bg-slate-900/90 border-b border-slate-800/80 flex items-center gap-3">
            ...
            {currentSelectedNote ? (
              <>
                <div className="space-y-3">
                  <div className="flex flex-wrap items-center justify-between gap-2 border-b border-slate-800 pb-3">
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs text-slate-400">• {currentSelectedNote.badge}</span>
                      </div>
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 rounded-xl bg-slate-800 hover:bg-indigo-600 text-slate-200 hover:text-white font-bold text-xs flex items-center gap-1.5 transition-all cursor-pointer"
                    >
                  ...
                  {/* Note text box */}
                  <div className="bg-[#080c16] border border-slate-800 rounded-2xl p-4 text-xs text-slate-200 font-sans leading-relaxed whitespace-pre-wrap max-h-[280px] overflow-y-auto">
                ...
                <div className="flex items-center justify-between gap-2 pt-3 border-t border-slate-800">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="p-2 rounded-xl bg-slate-950 hover:bg-rose-950/60 hover:text-rose-400 text-slate-400 border border-slate-800 transition-all cursor-pointer"
                    ...
                    <button
                      ...
                      className="px-3.5 py-1.5 rounded-xl bg-slate-950 hover:bg-slate-800 border border-slate-800 text-slate-300 font-bold text-xs flex items-center gap-1.5 transition-all cursor-pointer"
                    >
