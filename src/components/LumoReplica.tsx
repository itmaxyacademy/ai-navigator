...
export const LumoReplica: React.FC = () => {
  ...
  return (
    <div className="rounded-2xl border border-slate-800 bg-[#0b0a12] text-slate-100 overflow-hidden shadow-2xl flex flex-col h-[750px] relative font-sans select-none">
      {/* Top Header Navbar */}
      <header className="bg-[#0b0a12] px-4 py-3 flex items-center justify-between shrink-0 z-20 border-b border-slate-900">
        <div className="flex items-center gap-3">
          {/* Sidebar Toggle Button */}
          <button
            onClick={() => setIsSidebarOpen(!isSidebarOpen)}
            className="p-2 rounded-lg bg-slate-900/60 hover:bg-slate-800 text-slate-300 transition-colors cursor-pointer"
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="px-4 py-1.5 rounded-lg bg-[#201e2e] hover:bg-[#2a283c] border border-slate-700/60 text-white text-xs font-semibold transition-all cursor-pointer"
          >
      ...
      <div className="flex-1 flex overflow-hidden relative">
        ...
        <aside
          ...
          } bg-[#11101a] border-r border-slate-800/80 flex flex-col justify-between transition-all duration-300 shrink-0 z-10 p-3`}
        >
          ...
          <div className="space-y-4 min-w-0 overflow-y-auto">
            ...
            <div className="flex items-center gap-2 px-1 py-1">
              ...
              <span className="font-extrabold text-white text-base tracking-tight">Lumo AI</span>
            </div>
            ...
            <div className="flex items-center justify-between gap-2 pt-1">
              <button
                ...
                className="flex-1 py-2 px-3 rounded-xl bg-[#1d1b2c] hover:bg-[#27243c] border border-slate-800 text-white font-medium text-xs flex items-center gap-2 transition-all cursor-pointer truncate"
              >
              ...
              <div className="flex items-center gap-1 bg-[#1d1b2c] border border-slate-800 rounded-xl p-1.5 shrink-0">
                <Glasses className={`w-4 h-4 ${privacyMode ? 'text-purple-400' : 'text-slate-400'}`} />
                <button
            ...
            <div className="space-y-1 pt-1">
              <button
                ...
                className={`w-full px-3 py-2 rounded-xl text-xs font-semibold flex items-center gap-2.5 transition-all cursor-pointer ${
                  activeTab === 'chat'
                    ? 'bg-[#221f36] text-white font-bold'
                    : 'text-slate-300 hover:bg-[#1a1828] hover:text-white'
                }`}
              >
                    ...
                    <div
                      ...
                      className={`group p-2 rounded-xl text-xs transition-all cursor-pointer flex items-center justify-between gap-1 ${
                        activeThreadId === thread.id
                          ? 'bg-[#221f36] text-white font-bold'
                          : 'text-slate-400 hover:bg-[#181628] hover:text-slate-200'
                      }`}
                    >
          ...
          <div className="space-y-3 pt-2">
            <button
              ...
              className="w-full px-3 py-2 rounded-xl text-xs font-semibold text-slate-300 hover:bg-[#1a1828] flex items-center gap-2.5 cursor-pointer"
            >
            ...
            <div className="bg-[#181626] border border-slate-800/80 rounded-2xl p-3.5 space-y-2.5">
              <h4 className="text-xs font-bold text-white">Save your chat history</h4>
              ...
              <div className="space-y-1.5 pt-1">
                <button
                  onClick={() => handleOpenAccountModal('Create a free account')}
                  className="w-full py-2 rounded-xl bg-[#6149f6] hover:bg-[#523be3] text-white text-xs font-bold transition-all cursor-pointer shadow-md shadow-purple-600/20"
                >
                  Create a free account
                </button>
                <button
                  onClick={() => handleOpenAccountModal('Sign in')}
                  className="w-full py-1.5 rounded-xl text-slate-300 hover:text-white text-xs font-semibold transition-colors cursor-pointer text-center block"
                >
                  Sign in
                </button>
              </div>
        ...
        <main className="flex-1 bg-[#0b0a12] flex flex-col min-w-0 overflow-hidden relative">
          ...
          {activeTab === 'chat' && (
            <div className="flex-1 flex flex-col h-full min-h-0">
              <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-6 min-h-0">
                {messages.length === 0 ? (
                  ...
                  <div className="h-full flex flex-col items-center justify-center text-center space-y-6 max-w-lg mx-auto my-auto py-12">
                    ...
                    {/* Central Input Box */}
                    <div className="w-full relative bg-[#131220] border border-slate-800 focus-within:border-purple-500 rounded-3xl p-3.5 transition-all shadow-2xl space-y-3">
                      <textarea
                        value={inputPrompt}
                        ...
                        rows={2}
                        className="w-full bg-transparent text-white text-sm placeholder-slate-500 focus:outline-none resize-none leading-relaxed"
                      />
                      ...
                      <div className="flex items-center justify-between pt-1">
                        <div className="flex items-center gap-2 relative">
                          ...
                          <div className="relative">
                            <button
                              ...
                              className="px-2.5 py-1 rounded-xl bg-[#1b192c] border border-slate-800 text-xs font-semibold text-slate-300 hover:text-white flex items-center gap-1.5 cursor-pointer"
                            >
                            ...
                            {/* Tools Menu Popup */}
                            {isToolsDropdownOpen && (
                              <div className="absolute bottom-full left-0 mb-2 w-48 bg-[#1a182a] border border-slate-800 rounded-xl shadow-2xl p-2 z-50 space-y-1 text-left">
                                <span className="text-[10px] font-extrabold text-slate-400 uppercase block px-2 py-0.5">
                        ...
                        <div className="relative">
                          <button
                            ...
                            className="flex items-center gap-1.5 px-3 py-1 rounded-xl bg-[#1b192c] border border-slate-800 text-xs font-bold text-slate-300 hover:text-white cursor-pointer"
                          >
                          ...
                          {isModelDropdownOpen && (
                            <div className="absolute bottom-full right-0 mb-2 w-44 bg-[#1a182a] border border-slate-800 rounded-xl shadow-2xl p-1.5 z-50 space-y-1 text-left">
                              {models.map((m) => (
                                <button
                                  key={m}
                                  onClick={() => {
                                  ...
                                  className={`w-full text-left px-3 py-1.5 rounded-lg text-xs font-semibold flex items-center justify-between cursor-pointer ${
                                    selectedModel === m ? 'bg-purple-900/50 text-purple-200' : 'text-slate-300 hover:bg-slate-800'
                                  }`}
                                >
                                  <span>{m}</span>
                  ...
                  <div className="max-w-3xl mx-auto space-y-6">
                    {messages.map((msg) => (
                      ...
                      >
                        {msg.sender === 'lumo' && (
                          <div className="w-8 h-8 rounded-xl bg-[#6149f6] flex items-center justify-center text-white shrink-0 shadow-md">
                            🐱
                          </div>
                        )}
                        ...
                        <div className={`space-y-1 max-w-xl ${msg.sender === 'user' ? 'items-end' : 'items-start'}`}>
                          ...
                          <div
                            className={`p-4 rounded-2xl text-xs sm:text-sm leading-relaxed whitespace-pre-wrap break-words shadow-md ${
                              msg.sender === 'user'
                                ? 'bg-[#6149f6] text-white rounded-br-none'
                                : 'bg-[#141222] border border-slate-800 text-slate-200 rounded-bl-none'
                            }`}
                          >
                            {msg.text}
                        ...
                        {msg.sender === 'user' && (
                          <div className="w-8 h-8 rounded-xl bg-slate-800 p-1.5 flex items-center justify-center text-slate-300 shrink-0 shadow-md">
                    ...
                    {isLoading && (
                      <div className="flex gap-3 justify-start">
                        <div className="w-8 h-8 rounded-xl bg-[#6149f6] flex items-center justify-center text-white shrink-0 animate-pulse">
                          🐱
                        </div>
                        <div className="p-4 rounded-2xl bg-[#141222] border border-slate-800 text-xs text-purple-300 flex items-center gap-2">
              ...
              {messages.length > 0 && (
                <div className="p-3 bg-[#0b0a12] border-t border-slate-800/80 shrink-0">
                  <div className="max-w-3xl mx-auto space-y-2">
                    <div className="relative bg-[#131220] border border-slate-800 focus-within:border-purple-500 rounded-2xl p-2.5 transition-all shadow-xl">
                      <textarea
                        value={inputPrompt}
                        onChange={(e) => setInputPrompt(e.target.value)}
                        onKeyDown={(e) => {
                        ...
                        placeholder="Ask anything..."
                        rows={1}
                        className="w-full bg-transparent text-white text-xs sm:text-sm placeholder-slate-500 focus:outline-none resize-none leading-relaxed"
                      />
                        ...
                        <button
                          ...
                          className={`p-2 rounded-xl text-xs font-extrabold transition-all cursor-pointer flex items-center justify-center ${
                            inputPrompt.trim() && !isLoading
                              ? 'bg-[#6149f6] hover:bg-[#523be3] text-white shadow-md shadow-purple-600/30'
          ...
          {activeTab === 'images' && (
            <div className="flex-1 overflow-y-auto p-6 space-y-6">
              <div className="max-w-2xl mx-auto space-y-4">
                ...
                <div className="bg-[#131220] border border-slate-800 rounded-2xl p-4 space-y-3">
                  <div>
                    ...
                    <textarea
                      ...
                      rows={3}
                      className="w-full bg-[#0b0a12] border border-slate-800 rounded-xl p-3 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-purple-500"
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <select
                        ...
                        className="w-full bg-[#0b0a12] border border-slate-800 rounded-xl p-2 text-xs text-white focus:outline-none"
                      >
                  ...
                  <button
                    ...
                    className={`w-full py-2.5 rounded-xl font-extrabold text-xs flex items-center justify-center gap-2 transition-all cursor-pointer ${
                      imagePrompt.trim() && !isGeneratingImage
                        ? 'bg-[#6149f6] hover:bg-[#523be3] text-white shadow-lg shadow-purple-600/30'
                        : 'bg-slate-800 text-slate-500 cursor-not-allowed'
                    }`}
                  >
                    {isGeneratingImage ? (
                ...
                <div className="space-y-3 pt-2">
                  ...
                  {generatedImages.length === 0 ? (
                    <div className="p-8 text-center bg-[#131220]/50 border border-slate-800 rounded-2xl text-slate-500 text-xs space-y-1">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      {generatedImages.map((img) => (
                        <div key={img.id} className="bg-[#131220] border border-slate-800 rounded-2xl overflow-hidden space-y-2 p-2">
                          <img
                            src={img.url}
                            alt={img.prompt}
              ...
              <div className="max-w-2xl mx-auto space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 rounded-xl bg-[#6149f6] hover:bg-[#523be3] text-white text-xs font-bold flex items-center gap-1.5 transition-all cursor-pointer shadow-md"
                  >
                    <Plus className="w-4 h-4" />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                  {projectsList.map((proj) => (
                    <div
                      key={proj.id}
                      className="bg-[#131220] border border-slate-800 hover:border-purple-500/80 p-4 rounded-2xl space-y-2 transition-all cursor-pointer group"
                    >
                      <div className="flex items-center justify-between">
                      ...
                      <h4 className="text-sm font-extrabold text-white group-hover:text-purple-300">
                        {proj.name}
                      </h4>
          ...
          <div className="p-3 bg-[#0b0a12] border-t border-slate-900 text-center flex items-center justify-center gap-6 text-xs text-slate-500 font-semibold shrink-0">
            <span className="hover:text-slate-300 cursor-pointer">About</span>
            <span className="hover:text-slate-300 cursor-pointer">By Proton</span>
            <span className="hover:text-slate-300 cursor-pointer">For Business</span>
          </div>
        </main>
      </div>
      ...
      {isNewProjectModalOpen && (
        <div className="absolute inset-0 bg-slate-950/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-[#131220] border border-slate-800 rounded-2xl p-5 max-w-sm w-full space-y-4 shadow-2xl">
            <div className="flex items-center justify-between">
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-[#0b0a12] border border-slate-800 rounded-xl p-2.5 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-purple-500"
              />
            </div>
            ...
            <div className="flex items-center justify-end gap-2 pt-2">
              ...
              <button
                ...
                className="px-4 py-1.5 rounded-xl bg-[#6149f6] hover:bg-[#523be3] text-white text-xs font-bold"
              >
                Simpan Proyek
              </button>
            </div>
      ...
      {isAccountModalOpen && (
        <div className="absolute inset-0 bg-slate-950/85 backdrop-blur-md z-50 flex items-center justify-center p-4">
          <div className="bg-[#131220] border border-purple-800/80 rounded-2xl p-6 max-w-sm w-full space-y-4 shadow-2xl text-center">
            ...
            <div className="bg-[#0b0a12] border border-slate-800 p-3 rounded-xl text-[11px] text-slate-400 space-y-1">
            ...
            <button
              ...
              className="w-full py-2 rounded-xl bg-[#6149f6] hover:bg-[#523be3] text-white text-xs font-extrabold transition-all cursor-pointer"
            >
