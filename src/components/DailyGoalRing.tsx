    ...
    <div className="relative inline-block">
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/70 backdrop-blur-sm animate-fadeIn">
          <div
            className="w-full max-w-sm bg-slate-900 border border-slate-800 rounded-3xl p-5 shadow-2xl space-y-5 text-slate-100 relative"
          ...
          >
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-base font-extrabold text-white">Target Belajar Harian</h3>
                <p className="text-xs text-slate-400">Tetapkan komitmen menit belajar per hari.</p>
              </div>
            </div>
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold text-slate-300 block">Pilih Target Menit / Hari:</label>
            ...
            {onAddMinutes && (
              <div className="pt-3 border-t border-slate-800 flex items-center justify-between gap-3">
                <div className="text-[11px] text-slate-400">Membaca materi tambahan?</div>
                <button
                  onClick={() => onAddMinutes(5)}
                  className="px-3 py-1.5 bg-slate-800 hover:bg-slate-700 border border-slate-700 text-indigo-300 font-bold text-xs rounded-xl flex items-center gap-1.5 transition-colors cursor-pointer"
                >
