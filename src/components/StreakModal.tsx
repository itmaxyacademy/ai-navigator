          ...
          <div className="bg-slate-950 border border-slate-800 rounded-2xl p-5 space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs">
              <div className="p-3 bg-slate-900/80 border border-slate-800 rounded-xl space-y-1">
                ...
                <p className="text-[11px] text-slate-400">Setiap kali Anda menyelesaikan kuis modul baru.</p>
              </div>
              ...
              <div className="p-3 bg-slate-900/80 border border-slate-800 rounded-xl space-y-1">
                ...
                <p className="text-[11px] text-slate-400">Bonus spesial saat mencapai pertengahan kurikulum.</p>
              </div>
              ...
              <div className="p-3 bg-slate-900/80 border border-slate-800 rounded-xl space-y-1">
                ...
                <p className="text-[11px] text-slate-400">Setiap pengulangan kuis pada modul yang sudah selesai.</p>
              </div>
              ...
              <div className="p-3 bg-slate-900/80 border border-slate-800 rounded-xl space-y-1">
                ...
                <p className="text-[11px] text-slate-400">Saat menyelesaikan seluruh {totalModulesCount} modul.</p>
              </div>
            </div>
          </div>
        </div>
