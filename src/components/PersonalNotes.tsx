...
export const PersonalNotes: React.FC<PersonalNotesProps> = ({
  ...
  return (
    <div className="bg-slate-900 border border-slate-800 rounded-2xl shadow-xl overflow-hidden transition-all duration-300">
      {/* Header Bar */}
      <div className="bg-slate-950/80 p-4 border-b border-slate-800/80 flex items-center justify-between gap-3">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h3 className="font-bold text-sm text-white">Catatan Pribadi (Personal Notes)</h3>
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="p-1.5 rounded-lg bg-slate-900 hover:bg-slate-800 text-slate-300 border border-slate-800 transition-all cursor-pointer"
        ...
        <div className="p-4 space-y-3.5 animate-in fade-in duration-200">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              ...
              className="px-2.5 py-1 rounded-lg bg-slate-950 hover:bg-slate-800 border border-slate-800 text-slate-300 text-[11px] font-medium flex items-center gap-1 transition-all cursor-pointer"
            >
          ...
          <div className="relative">
            <textarea
              ...
              rows={isCompact ? 4 : 6}
              className="w-full bg-[#090d16] border border-slate-800 focus:border-indigo-500 rounded-xl p-3.5 text-xs sm:text-sm text-slate-100 placeholder-slate-500 focus:outline-none transition-all leading-relaxed font-sans resize-y"
            />
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 pt-1 border-t border-slate-800/60 text-xs">
            ...
            <div className="flex items-center gap-2 justify-end">
              {showClearConfirm ? (
                ...
                <button
                  ...
                  disabled={!noteText}
                  className="p-2 rounded-xl bg-slate-950 hover:bg-rose-950/50 hover:text-rose-400 text-slate-400 border border-slate-800 transition-all disabled:opacity-40 cursor-pointer"
                  title="Hapus Catatan"
                >
              ...
              <button
                ...
                className="px-3 py-1.5 rounded-xl bg-slate-950 hover:bg-slate-800 border border-slate-800 text-slate-300 hover:text-white flex items-center gap-1.5 transition-all disabled:opacity-40 cursor-pointer"
