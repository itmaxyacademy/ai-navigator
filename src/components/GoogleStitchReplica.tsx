    ...
    <div className="relative w-full rounded-2xl border border-slate-200 dark:border-slate-800 bg-[#121316] text-slate-800 dark:text-slate-100 overflow-hidden shadow-2xl flex flex-col min-h-[680px]">
        ...
        <div className="flex items-center bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg p-1 gap-1 shrink-0">
          <button
            ...
            className={`flex items-center gap-1.5 px-3 py-1 text-xs font-bold rounded-md transition-all ${
              deviceMode === 'desktop' ? 'bg-cyan-600 text-slate-900 dark:text-white shadow' : 'text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:text-slate-200'
            }`}
          >
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-3 py-1 text-xs font-bold rounded-md transition-all ${
              deviceMode === 'mobile' ? 'bg-cyan-600 text-slate-900 dark:text-white shadow' : 'text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:text-slate-200'
            }`}
          >
      ...
      <div className="min-h-[56px] py-2 border-b border-slate-200 dark:border-slate-800/80 bg-[#181a20]/90 backdrop-blur-md px-3 sm:px-4 flex flex-wrap sm:flex-nowrap items-center justify-between gap-3 shrink-0 z-30">
        <div className="flex flex-wrap items-center gap-2 sm:gap-3 max-w-full">
          ...
          >
            <span className="font-semibold text-sm sm:text-base text-slate-700 dark:text-slate-200 group-hover:text-cyan-400 transition-colors break-words whitespace-normal leading-snug max-w-[180px] sm:max-w-xs">
        ...
        <div className="flex items-center gap-1.5 sm:gap-3 flex-wrap max-w-full">
          ...
          <button
            ...
            className="p-2 hover:bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:text-white rounded-lg transition-colors flex items-center gap-1.5 flex-wrap max-w-full"
          ...
          <button
            ...
            className="px-3 py-1.5 bg-slate-100 dark:bg-slate-800 hover:bg-slate-700 text-slate-700 dark:text-slate-200 rounded-lg text-xs font-medium flex items-center gap-1.5 transition-colors border border-slate-300 dark:border-slate-700 flex-wrap max-w-full"
          >
          ...
          <button
            ...
            className="px-3 py-1.5 bg-cyan-600 hover:bg-cyan-500 text-slate-900 dark:text-white rounded-lg text-xs font-medium flex items-center gap-1.5 transition-colors shadow-lg shadow-cyan-600/20 flex-wrap max-w-full"
          >
          ...
          <div 
            ...
            className="w-8 h-8 rounded-full bg-cyan-600 text-slate-900 dark:text-white font-bold text-xs flex items-center justify-center cursor-pointer border border-cyan-400/40 shadow-sm"
          >
            M
          </div>
        </div>
      ...
      <div className="relative flex-1 bg-[#121316] overflow-hidden min-h-[560px] flex min-w-0">
        ...
        <div className={`z-20 transition-all duration-300 ${
          ...
          {isAgentLogOpen && (
            <div className="flex-1 overflow-y-auto my-3 space-y-4 pr-1 text-xs min-w-0">
              {/* User Prompt Chip */}
              <div 
              ...
              >
                <div className="flex items-center gap-2 truncate flex-wrap max-w-full">
                  ...
                  <span className="text-slate-600 dark:text-slate-300 break-words whitespace-normal leading-snug">used #ffb034 as the primary theme...</span>
                </div>
                <div className="flex items-center gap-1 flex-wrap max-w-full">
                  <button 
                    ...
                    className="p-1 hover:bg-slate-100 dark:bg-slate-800 rounded text-slate-500 dark:text-slate-400"
                  >
              ...
              <div className="space-y-3 text-slate-600 dark:text-slate-300 leading-relaxed bg-white dark:bg-slate-900/50 rounded-xl p-3 border border-slate-200 dark:border-slate-800/60">
                <p className="font-semibold text-slate-700 dark:text-slate-200">Perubahan Antarmuka Maxy Academy:</p>
                ...
                <p className="pt-2 text-slate-500 dark:text-slate-400 italic text-[11px] border-t border-slate-200 dark:border-slate-800">
        ...
        <div className="flex-1 relative overflow-auto p-4 sm:p-8 z-10 min-w-0">
          ...
          <div className="grid grid-cols-[repeat(auto-fit,minmax(280px,1fr))] gap-6 sm:gap-8 max-w-6xl mx-auto py-6">
            ...
            >
              ...
              <div className="space-y-3 bg-[#15171e] p-3 rounded-xl border border-slate-200 dark:border-slate-800">
                ...
                <div className="flex items-center justify-between bg-white dark:bg-slate-900 p-2 rounded-lg">
                  <span className="text-2xl font-bold font-serif text-slate-900 dark:text-white">Aa</span>
                  <div className="text-right">
                    <p className="text-[10px] text-slate-500 dark:text-slate-400">HeadLine & Body</p>
            ...
            >
              ...
              <div className="bg-slate-100 dark:bg-slate-950 rounded-xl p-3 border border-slate-200 dark:border-slate-800 space-y-2.5 text-xs">
                ...
                <div className="space-y-1">
                  <p className="text-[10px] text-slate-500 dark:text-slate-400">Selamat datang kembali,</p>
                  <p className="font-extrabold text-sm text-slate-900 dark:text-white">Alex Mercer</p>
                </div>
                ...
                <div className="flex justify-around pt-1 border-t border-slate-200 dark:border-slate-800 text-[9px] text-slate-500 dark:text-slate-400">
            ...
            >
              ...
              <div className="space-y-3 bg-[#15171e] p-3 rounded-xl border border-slate-200 dark:border-slate-800">
                <div className="grid grid-cols-3 gap-1.5">
                  ...
                  <div className="bg-slate-100 dark:bg-slate-800 h-10 rounded-lg p-1 text-[9px] font-bold text-slate-900 dark:text-white">Dark Neutral</div>
                  <div className="bg-cyan-600 h-10 rounded-lg p-1 text-[9px] font-bold text-slate-900 dark:text-white">Cyan Accent</div>
                </div>
            ...
            >
              ...
              <div className="bg-slate-100 dark:bg-slate-950 rounded-xl p-3 border border-slate-200 dark:border-slate-800 space-y-2 text-xs">
                ...
                <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg p-2 flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-[9px] text-slate-500 dark:text-slate-400">Northwood Kinetic Hub</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="bg-slate-100 dark:bg-slate-950 rounded-xl p-3 border border-slate-200 dark:border-slate-800 space-y-2 text-xs text-center">
                <div className="w-10 h-10 rounded-full bg-cyan-600 text-slate-900 dark:text-white font-extrabold flex items-center justify-center mx-auto text-sm">AM</div>
                <div>
                  <p className="font-bold text-slate-900 dark:text-white text-xs">Alex Mercer</p>
                  <p className="text-[9px] text-amber-400 font-bold uppercase tracking-wider">MENTOR</p>
                </div>
                <div className="text-left text-[10px] bg-white dark:bg-slate-900 p-2 rounded-lg space-y-1 text-slate-600 dark:text-slate-300">
            ...
            >
              ...
              <div className="bg-slate-100 dark:bg-slate-950 rounded-xl p-3 border border-slate-200 dark:border-slate-800 space-y-2 text-xs text-center">
                ...
                <p className="text-[10px] text-slate-600 dark:text-slate-300 font-bold">Welcome Back, Staff</p>
                <div className="space-y-1.5 text-left text-[10px]">
                  <div className="p-1.5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded text-slate-500 dark:text-slate-400">staff@maxyacademy.com</div>
                  <div className="p-1.5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded text-slate-500 dark:text-slate-400">••••••••</div>
                </div>
        ...
        <div className="absolute right-3 sm:right-4 top-1/2 -translate-y-1/2 z-20 flex flex-col gap-1 bg-[#1a1d24]/90 backdrop-blur-md border border-slate-300 dark:border-slate-700/80 rounded-2xl p-1.5 shadow-2xl">
          {[
            ...
            return (
              <button
                ...
                className={`p-2 rounded-xl transition-all ${
                  isActive 
                    ? 'bg-cyan-600 text-slate-900 dark:text-white shadow-lg shadow-cyan-600/30' 
                    : 'text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:bg-slate-800 hover:text-slate-700 dark:text-slate-200'
                }`}
                title={tool.title}
              >
        ...
        <div className="absolute right-3 sm:right-4 bottom-24 z-20 flex items-center gap-1.5 bg-[#1a1d24]/90 backdrop-blur-md border border-slate-300 dark:border-slate-700/80 rounded-xl px-2 py-1 shadow-xl text-xs flex-wrap max-w-full">
          <button 
          ...
          <button 
            ...
            className="px-2 py-0.5 font-bold text-slate-600 dark:text-slate-300 hover:text-cyan-400"
          >
            {zoomLevel}%
          </button>
          <button 
      ...
      <div className="relative border-t border-slate-200 dark:border-slate-800/80 bg-[#16181e]/95 backdrop-blur-md p-3 sm:p-4 z-30">
        <form onSubmit={handlePromptSubmit} className="max-w-4xl mx-auto space-y-2">
          
          <div className="bg-[#1e212b] border border-slate-300 dark:border-slate-700/80 focus-within:border-cyan-500/80 rounded-2xl p-2 sm:p-3 shadow-xl transition-all">
            ...
            <input
              ...
              className="w-full bg-transparent border-none text-slate-800 dark:text-slate-100 placeholder-slate-400 focus:outline-none text-sm px-2 py-1"
            />

            {/* Prompt Action Toolbar Row */}
            <div className="flex flex-wrap items-center justify-between gap-2 pt-2 border-t border-slate-200 dark:border-slate-800/80 mt-2">
              
              <div className="flex items-center gap-1.5 sm:gap-2 relative flex-wrap max-w-full">
                ...
                <div className="relative">
                  <button
                    ...
                    className={`w-8 h-8 rounded-full flex items-center justify-center transition-all ${
                      isPlusMenuOpen ? 'bg-cyan-600 text-slate-900 dark:text-white' : 'bg-slate-100 dark:bg-slate-800 hover:bg-slate-700 text-slate-600 dark:text-slate-300'
                    }`}
                  ...
                  <AnimatePresence>
                    {isPlusMenuOpen && (
                      <motion.div
                        ...
                        className="absolute left-0 bottom-12 w-56 bg-[#232733] border border-slate-300 dark:border-slate-700 rounded-2xl p-2 shadow-2xl z-50 text-xs space-y-1"
                      >
                        <button
                          type="button"
                          onClick={() => {
                          ...
                          className="w-full text-left px-3 py-2 hover:bg-slate-100 dark:bg-slate-800 rounded-xl flex items-center gap-2 text-slate-700 dark:text-slate-200 transition-colors flex-wrap max-w-full"
                        >
                        ...
                        <div className="border-t border-slate-300 dark:border-slate-700/60 my-1" />
                ...
                <div className="relative">
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-full font-serif font-extrabold text-sm flex items-center justify-center transition-all ${
                      isSlashMenuOpen ? 'bg-cyan-600 text-slate-900 dark:text-white' : 'bg-slate-100 dark:bg-slate-800 hover:bg-slate-700 text-slate-600 dark:text-slate-300'
                    }`}
                  ...
                  <AnimatePresence>
                    {isSlashMenuOpen && (
                      <motion.div
                        ...
                        animate={{ opacity: 1, y: 0, scale: 1 }}
                        exit={{ opacity: 0, y: 10, scale: 0.95 }}
                        className="absolute left-0 bottom-12 w-64 bg-[#232733] border border-slate-300 dark:border-slate-700 rounded-2xl p-2 shadow-2xl z-50 text-xs space-y-1 max-h-80 overflow-y-auto"
                      >
                        {[
                          ...
                          return (
                            <button
                              ...
                              className="w-full text-left px-3 py-2 hover:bg-slate-100 dark:bg-slate-800 rounded-xl flex items-center gap-2.5 text-slate-700 dark:text-slate-200 transition-colors flex-wrap max-w-full"
                            >
                ...
                <div className="relative">
                  <button
                    ...
                    className="flex items-center gap-1.5 px-2.5 py-1 bg-slate-100 dark:bg-slate-800 hover:bg-slate-700 border border-slate-300 dark:border-slate-700 rounded-full text-xs text-slate-700 dark:text-slate-200 flex-wrap max-w-full"
                  >
                  ...
                  {isThemeDropdownOpen && (
                    <div className="absolute left-0 bottom-10 w-44 bg-[#232733] border border-slate-300 dark:border-slate-700 rounded-xl p-2 shadow-xl z-50 text-xs space-y-1">
                      {['Amber (#ffb034)', 'Cyan (#06b6d4)', 'Indigo (#6366f1)', 'Emerald (#10b981)'].map((theme) => (
                        <button
                          ...
                          className="w-full text-left px-2 py-1.5 hover:bg-slate-100 dark:bg-slate-800 rounded text-slate-700 dark:text-slate-200 flex items-center gap-2 flex-wrap max-w-full"
                        >
                ...
                <div className="relative">
                  <button
                    ...
                    className="flex items-center gap-1.5 px-2.5 py-1 bg-slate-100 dark:bg-slate-800 hover:bg-slate-700 border border-slate-300 dark:border-slate-700 rounded-full text-xs font-bold text-cyan-300 flex-wrap max-w-full"
                  >
                  ...
                  {isModelDropdownOpen && (
                    <div className="absolute left-0 bottom-10 w-40 bg-[#232733] border border-slate-300 dark:border-slate-700 rounded-xl p-2 shadow-xl z-50 text-xs space-y-1">
                      {['3 Flash', '3 Pro', '2.5 Flash'].map((model) => (
                        <button
                          ...
                          className="w-full text-left px-2 py-1.5 hover:bg-slate-100 dark:bg-slate-800 rounded text-slate-700 dark:text-slate-200 font-medium"
                        >
                          {model}
                        </button>
                      ))}
              ...
              <div className="flex items-center gap-2 flex-wrap max-w-full">
                <button
                  ...
                  className="p-2 hover:bg-slate-100 dark:bg-slate-800 text-amber-400 rounded-xl transition-colors"
                ...
                <button
                  ...
                  className="p-2 bg-cyan-600 hover:bg-cyan-500 text-slate-900 dark:text-white rounded-xl transition-all shadow-lg shadow-cyan-600/30 disabled:opacity-50"
        ...
        {activeModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-100 dark:bg-slate-950/80 backdrop-blur-sm">
            <motion.div
              ...
              className="relative w-full max-w-md bg-[#1d212c] border border-cyan-500/40 rounded-3xl p-6 shadow-2xl text-slate-800 dark:text-slate-100 space-y-4"
            >
              <button
                onClick={() => setActiveModal(null)}
                className="absolute top-4 right-4 p-1.5 rounded-full bg-slate-100 dark:bg-slate-800 hover:bg-slate-700 text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:text-white"
              >
                <X className="w-4 h-4" />
              </button>
              ...
              {activeModal.parameters && activeModal.parameters.length > 0 && (
                <div className="bg-white dark:bg-emerald-50/50 dark:bg-slate-900/80 p-3 rounded-2xl border border-slate-200 dark:border-slate-800/80 space-y-1.5 text-xs text-slate-600 dark:text-slate-300">
                  <p className="font-bold text-cyan-400 flex items-center gap-1.5 flex-wrap max-w-full">
              ...
              {activeModal.usageGuide && activeModal.usageGuide.length > 0 && (
                <div className="bg-cyan-950/40 p-3 rounded-2xl border border-cyan-800/50 space-y-1.5 text-xs text-slate-600 dark:text-slate-300">
                  <p className="font-bold text-cyan-300 flex items-center gap-1.5 flex-wrap max-w-full">
              ...
              <button
                onClick={() => setActiveModal(null)}
                className="w-full py-2.5 bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-slate-900 dark:text-white font-bold rounded-2xl text-xs transition-all shadow-lg"
              >
                Mengerti & Lanjutkan
              </button>
            </motion.div>
        ...
        {previewModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-100 dark:bg-slate-950/90 backdrop-blur-md">
            <motion.div
              ...
              className="relative w-full max-w-sm bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl overflow-hidden shadow-2xl flex flex-col h-[600px]"
            >
              <div className="bg-slate-100 dark:bg-slate-800 px-4 py-3 flex items-center justify-between border-b border-slate-300 dark:border-slate-700">
                <div className="flex items-center gap-2 flex-wrap max-w-full">
                  <Smartphone className="w-4 h-4 text-cyan-400" />
                  <span className="text-xs font-bold text-slate-900 dark:text-white">Maxy Warriors Live Preview</span>
                </div>
                <button
                  onClick={() => setPreviewModalOpen(false)}
                  className="p-1 hover:bg-slate-700 rounded-full text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:text-white"
                >
                  <X className="w-4 h-4" />
                </button>
              </div>

              <div className="flex-1 p-4 bg-slate-100 dark:bg-slate-950 overflow-y-auto space-y-4 text-xs min-w-0">
                <div className="p-3 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 space-y-2">
                  ...
                  <p className="text-sm font-extrabold text-slate-900 dark:text-white">Halo, Alex Mercer!</p>
                  <p className="text-slate-500 dark:text-slate-400 text-[10px]">Lokasi: Main Campus (HQ)</p>
                </div>
                ...
                <div className="p-4 bg-gradient-to-br from-indigo-900/60 to-purple-900/60 border border-indigo-700/50 rounded-2xl space-y-3">
                  <p className="font-bold text-slate-900 dark:text-white">Status Presisi Hari Ini</p>
                  <div className="bg-white dark:bg-emerald-50/50 dark:bg-slate-900/80 p-2.5 rounded-xl border border-slate-200 dark:border-slate-800 flex justify-between items-center text-[10px]">
                    <span className="text-slate-600 dark:text-slate-300">Jam Masuk:</span>
                    <span className="text-cyan-400 font-bold">08:30 WIB</span>
                  </div>
                  <button 
                    onClick={() => alert('Presisi Berhasil Dicatat!')}
                    className="w-full py-2 bg-cyan-600 hover:bg-cyan-500 text-slate-900 dark:text-white font-bold rounded-xl text-center shadow-lg"
                  >
